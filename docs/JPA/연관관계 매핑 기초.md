...
<img src="/img/10.JPG" width="500px" height="300px" title="table2" alt="시나리오"></img><br/><br/>
...
## 단방향 연관관계?
- 객체지향스럽게 설계 <br/>
    - Member 객체에 teamId 대신 Team을 넣어준다.
    - Team을 넣어주면 Member 객체와 무슨 관계인지를 명시해 주어야 한다. <br/>
      (다대일? 일대다? 일대일?) => **Member : Team = N : 1 이므로 @ManyToOne 을 넣어주어야 한다.**
    - Member 객체의 Team과 Member 테이블의 TEAM_ID 와 매핑을 해야한다. <br/>
      - => @JoinColumn(name = "TEAM_ID)
    

<img src="/img/11.JPG" width="500px" height="300px" title="table2" alt="객체지향스럽게"></img><br/>
...
* Member와 Team 영속성 컨텍스트에 저장
    ...
    ```
<img src="/img/12.JPG" width="400px" height="300px" title="table2" alt="2개의 table 생성됨"></img><br/>
