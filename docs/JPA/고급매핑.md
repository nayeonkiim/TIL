...
...
```<br/><br/>
<img src="https://github.com/nayeonkiim/TIL/blob/master/static/img/26.JPG?raw=true" width="700px" height="100px" title="table1" alt="상속매핑"></img><br/>
...
- Item 클래스로 조회 시 **UNION ALL**로 MOVIE, ALBUM, BOOK 테이블을 모두 SELECT 한다.<br/>
