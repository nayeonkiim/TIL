...
- 공통 내부 프로퍼티
<img src="https://github.com/nayeonkiim/TIL/tree/master/docs/JavaScript/img/2.JPG?raw=true" width="700px" height="350px" title="js" alt="내부 프로퍼티"></img><br/>
- [[Prototype]] : Math와 같이 Prototype이 없는 오브젝트도 있다.
- +) 프로퍼티 디스크립터<br/>
    - <img src="https://github.com/nayeonkiim/TIL/tree/master/docs/JavaScript/img/3.JPG?raw=true" width="700px" height="200px" title="js" alt="내부 프로퍼티"></img><br/>
...
- 선택적 내부 프로퍼티
    - 오브젝트에 따라 선택적 설정
    <img src="https://github.com/nayeonkiim/TIL/tree/master/docs/JavaScript/img/4.JPG?raw=true" width="700px" height="300px" title="js" alt="내부 프로퍼티"></img><br/>
